...
String appName = 'Go Vet';

const Color backgroundblack = Color(0xff1479FF);
...
const Color appColorBlack = backgroundblack;
...
/*String baseUrl() {
  return 'https://govet.onclick-eg.com/api/';
}*/
String baseUrl = 'https://govet.onclick-eg.com/api/';
