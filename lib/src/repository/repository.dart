...
class Repository {
  ...
  Future<GetProdByCatID> storeApiRepository(String id) async {
    print("storeApiRepository");
    return await StoreApi().storeApi(id);
  }

  Future<GetProdByCatID> storeProductAPiRepository(String id) async {
    print("storeProductAPiRepository");
    return await StoreApi().productApi(id);
  }

  Future<GetAllProdCategory> categoryApiRepository() async {
    print('categoryApiRepository');
