  ...
  getUserDataApicall() async {
    ...
    try {
      ...
      Fluttertoast.showToast(
          msg: translation(context).no_Internet_connection,
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              cursorColor: Colors.grey,
                              decoration: InputDecoration(
                                labelText: translation(context).enterEmail,
                                labelStyle: TextStyle(color: Colors.grey),
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              cursorColor: Colors.grey,
                              decoration: InputDecoration(
                                labelText: translation(context).enter_City,
                                labelStyle: TextStyle(color: Colors.grey),
                                focusColor: Colors.grey,
                              ),
                            ),
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              cursorColor: Colors.grey,
                              decoration: InputDecoration(
                                labelText: translation(context).enter_Mobile_no,
                                labelStyle: TextStyle(color: Colors.grey),
                                focusColor: Colors.grey,
                              ),
                            ),
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              cursorColor: Colors.grey,
                              decoration: InputDecoration(
                                labelText: translation(context).enter_Address,
                                labelStyle: TextStyle(color: Colors.grey),
                                focusColor: Colors.grey,
                              ),
                            ),
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: new Text(translation(context).are_you_sure_you_want_to_log_out),
          actions: <Widget>[
            new TextButton(
    ...
    containerForSheet<String>(
      ...
      child: CupertinoActionSheet(
        actions: <Widget>[
          ...
          CupertinoActionSheetAction(
            child: Text(
              translation(context).photo_and_Video_Library,
              style: TextStyle(color: Colors.black, fontSize: 15),
            ),
            onPressed: () {
              getImageFromGallery();
