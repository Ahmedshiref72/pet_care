      ...
      child: Container(
        child: Scaffold(
          appBar: AppBar(
            ...
            elevation: 0,
            title: Text(translation(context).filter, style: TextStyle(color: appColorBlack)),
            leading: InkWell(
              onTap: () {
        ...
        children: [
          ...
          user!.servic!.length > 0
              ...
              : SizedBox(
                  ...
                  child: Center(
                    child: Text(
                      translation(context).not_found_any_service,
                      style: TextStyle(
                        color: Colors.black,
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "\ (" + data.reviewCount.toString() + translation(context).review,
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                         translation(context).price_Unit+ data.priceUnit.toString(),
                          style:
                        ...
                        Padding(
                          ...
                          child: Text(
                           translation(context).duration + data.duration.toString() + translation(context).hour,
