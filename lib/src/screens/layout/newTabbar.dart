...
//   ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PageStorage(bucket: bucket, child: currentIndex),
                      ...
                      MaterialButton(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _currentIndex == 0 ? Text(translation(context).home) : Text(''),
                          ],
                        ),
                      ),
                      MaterialButton(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _currentIndex == 1 ? Text(translation(context).services) : Text(''),
                          ],
                        ),
                      )
                    ],
                      ...
                      MaterialButton(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _currentIndex == 2 ? Text(translation(context).product) : Text(''),
                          ],
                        ),
                      ),
                      MaterialButton(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _currentIndex == 3 ? Text(translation(context).profile) : Text(''),
                          ],
                        ),
                      )
                    ],
