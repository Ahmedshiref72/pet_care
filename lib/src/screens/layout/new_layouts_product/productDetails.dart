                    ...
                    ? SizedBox(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor: Colors.black, // <-- Splash color
                          ),
                          child: Icon(
                            Icons.favorite,
                            color: Colors.red,
                          ...
                          onPressed: () {
                            unLikeBloc
                              ...
                              if (value.status == 1) {
                                ...
                                Flushbar(
                                  title: translation(context).fail,
                                  message: value.msg,
                                  duration: Duration(seconds: 3),
                                  icon: Icon(
                                    Icons.error,
                              ...
                              if (value.responseCode == "1") {
                                ...
                                Flushbar(
                                  ...
                                  mainButton: TextButton(
                                    ...
                                    child: Text(
                                      translation(context).go_to_wish_list,
      ...
      Padding(
        ...
        child: Container(
          ...
          child: TabBar(
            ...
            tabs: [
              Container(child: Text(translation(context).description)),
              Container(child: Text(translation(context).how_To_Use)),
              Container(child: Text(translation(context).reviews)),
            ],
                      ...
                      (userResponse) {
                        ...
                        if (userResponse.responseCode ==
                          ...
                          Flushbar(
                            backgroundColor: appColorWhite,
                            messageText: Text(
                              translation(context).item_added,
                              style: TextStyle(
                                fontSize: 13,
                                color: appColorBlack,
                              ),
                            ...
                            mainButton: TextButton(
                              ...
                              child: Text(
                                translation(context).go_to_cart,
                                style: TextStyle(color: appColorBlack),
                              ),
                            ),
                            icon: Icon(
                          ...
                          child: Stack(
                            children: [
                              Align(
                                ...
                                child: Text(
                                  translation(context).aDD_TO_CART,
                  ...
                  onTap: () {
                    Flushbar(
                      ...
                      mainButton: TextButton(
                        ...
                        child: Text(
                          translation(context).click_here_to_login,
                          style: TextStyle(color: appColorBlack),
                        ),
                      ),
                      icon: Icon(
