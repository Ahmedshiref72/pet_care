...
class ProductList extends StatefulWidget {
  String? id;
  final bool isStoreProducts;
  ProductList({Key? key, this.id, this.isStoreProducts = false})
      : super(key: key);
...
class _ProductListState extends State<ProductList> {
  @override
  void initState() {
    storeBloc.storeSink(widget.id!, isStoreProducts: widget.isStoreProducts);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appbar(translation(context).products, context),
      body: Container(
          ...
          child: RefreshIndicator(
            ...
            child: StreamBuilder<GetProdByCatID>(
                ...
                builder: (context, AsyncSnapshot<GetProdByCatID> snapshot) {
                  ...
                  List<Product>? allService = snapshot.data!.products != null
  ...
  Widget serviceCard(Product data) {
    // String? id = data.id;
    //print("id: "+id);
    return InkWell(
      onTap: () {
