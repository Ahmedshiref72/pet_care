...
import '../new_layouts_product/productList.dart';

// ignore: must_be_immutable
class NewStoreDetailScreen extends StatefulWidget {
  final String? id;
  NewStoreDetailScreen(this.id, {this.isFromNew = false});
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => StoreImages(id)));
                              },
                              child: CachedNetworkImage(
