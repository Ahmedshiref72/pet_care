  ...
  Widget textReview() {
    return Padding(
      ...
      child: ReviewtextField(
        ...
        maxLines: 4,
        hintText:translation(context).write_your_review,
      ),
    );
  }
      ...
      child: Column(
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              Text(
                translation(context).how_was_your,
                style: TextStyle(
                    letterSpacing: 1,
                    color: Colors.black,
                    fontSize: 17,
          ...
          Row(
            ...
            children: <Widget>[
              Text(
                translation(context).experience_with_this_place,
                style: TextStyle(
                    letterSpacing: 1,
                    color: Colors.black,
                    fontSize: 17,
            ...
            onPressed: () {
              if (_reviewController.text.length > 0 && rateValue != null) {
                ...
                Fluttertoast.showToast(
                    msg: translation(context).write_Review_or_Select_Rating,
