...
class ServiceByStoreList extends StatefulWidget {
  final String? resid;
  final bool isProductsOnly;
  ServiceByStoreList(this.resid,{this.isProductsOnly = false});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          translation(context).service_List,
                ...
                builder: (context, AsyncSnapshot<GetServiceModel> snapshot) {
                  ...
                  return allService!.length > 0
                      ...
                      : SizedBox(
                          ...
                          child: Center(
                            child: Text(translation(context).dont_have_any_Service),
                          ),
                        );
                }),
          ],
